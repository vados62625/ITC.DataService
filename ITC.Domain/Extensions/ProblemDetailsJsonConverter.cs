...
public class ProblemDetailsJsonConverter : JsonConverter<ProblemDetailsDto>
{
    ...
    public override ProblemDetailsDto Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
    ...
    public override void Write(Utf8JsonWriter writer, ProblemDetailsDto value, JsonSerializerOptions options)
    {
    ...
    private static void ReadValue(ref Utf8JsonReader reader, ProblemDetailsDto value, JsonSerializerOptions options)
    {
    ...
    private static void WriteProblemDetails(Utf8JsonWriter writer, ProblemDetailsDto value, JsonSerializerOptions options)
    {
        if (value.Type != null)
        {
